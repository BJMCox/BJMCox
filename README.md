...
I primarily speak Python and Julia, but some C, C++, and Rust has managed to worm through my defences. 

Other languages include: native English, A2 (allegedly, doesn't feel like it) Deutsch. 

My interests outside of work (that you will see scant evidence of here) include:
- Ballet (Russian, relearning)
- Hardware hacking (current project: medication thumper)
